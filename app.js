...
var createNewTaskElement=function(taskString){
  ...
  listItem.classList.add('task-list__item', 'flex')
  
    //input (checkbox)
  var checkBox = document.createElement("input");//checkbx
  checkBox.classList.add('task-list__input', 'input-checkbox')
  ...
  editInput.classList.add('task-list__input', 'input-text')
    //button.edit
  var editButton = document.createElement("button");//edit button
  editButton.classList.add('task-list__btn', 'task-list__btn--edit', 'btn')

    //button.delete
  var deleteButton = document.createElement("button");//delete button
  var deleteButtonImg = document.createElement("img");//delete button image
  deleteButton.classList.add('task-list__btn', 'task-list__btn--delete', 'btn');
